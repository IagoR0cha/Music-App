                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8),
                                          child: TextFormField(
                                            decoration: InputDecoration(labelText: 'Duração da música'),
                                            onSaved: (value) {
                                              musicDuration =value!;
                                            },
                                          )
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8),
                                          child: TextFormField(
                                            decoration: InputDecoration(labelText: 'Estilo da música'),
                                            onSaved: (value) {
                                              musicStyle = value!;
                                            },
                                          )
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              await musicController.edit(musicController.musics[index].id!, widget.currentArtist.id!, musicCurrent,);
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          await musicController.delete(widget.currentArtist.id!, musicController.musics[index].id!);
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Artista deletado!'))
                          );
                        },
                      )
                    ]
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              await musicController.create(musicCurrent, widget.currentArtist.id!);
                              ScaffoldMessenger.of(context)
                                .showSnackBar(SnackBar(
                                  content: Text(
                                    'Salvo com sucesso!'
