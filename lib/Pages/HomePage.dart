...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<ArtistsController, MusicController>(
      ...
      appBar: AppBar(title: Text('Artistas'), elevation: 0),
      body: Container(
            ...
            return GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => MusicPage(currentArtist: artistsController.artists[index]),
                  )
                );
              },
              child: Card(
                    ...
                    Row(
                      ...
                      children: [
                                          ...
                                          Padding(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () async {
                                                ...
                                                await artistsController.edit(artistsController.artists[index].id!, artistCurrent);
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            await artistsController.delete(artistsController.artists[index].id!);
